// wrappers and helpers that hit the insight api on a full b4bcore node
...
function Insight(url) {
    ...
    $.checkArgument(url, 'First argument is required, please include the URL of the API root (e.g. https://b4bcoin.network/api)');
