 ...
 * numbers for each b4bcoin network. Currently only supporting "livenet"
...
addNetwork({
  ...
  port: 8767,
  dnsSeeds: [
    'seed-b4b.b4bcoin.org',
    'seed-b4b.bitactivate.com'
  ]
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'seed-testnet-b4b.b4bcoin.org',
    'seed-testnet-b4b.bitactivate.com'
  ]
};
