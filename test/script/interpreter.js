...
var script_valid = require('../data/b4bd/script_valid');
var script_invalid = require('../data/b4bd/script_invalid');
var tx_valid = require('../data/b4bd/tx_valid');
var tx_invalid = require('../data/b4bd/tx_invalid');

//the script string format used in b4bd data tests
Script.fromb4bdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromb4bdString(vector[0]);
    var scriptPubkey = Script.fromb4bdString(vector[1]);
  ...
  describe('b4bd script evaluation fixtures', function() {
  ...
  describe('b4bd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //b4bd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromb4bdString(scriptPubKeyStr);
          });
