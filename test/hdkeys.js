...
var HDPrivateKey = b4bcore.HDPrivateKey;
var HDPublicKey = b4bcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = b4bcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(b4bcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(b4bcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      b4bcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = b4bcore.PublicKey.fromPoint;
      b4bcore.PublicKey.fromPoint = function() {
        b4bcore.PublicKey.fromPoint = unstubbed;
